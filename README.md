...
| `maxSteps` | `number` | `1000000` | Deterministic evaluator-work budget. It charges AST work, lambda calls, spread/literal loops, and receiver-length estimates before linear native methods. Opaque registered-extension work is excluded. Exceeding it throws `BonsaiSecurityError('MAX_STEPS', ...)`. `0` disables it. |
